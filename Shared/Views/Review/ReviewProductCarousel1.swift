...
struct ReviewProductCarousel1: View {
    ...
    @State var arrayOfReviewQuestions: [String] = ["Overall, how would you rate these Joggers?", "What's your favorite thing about them?", "How would you summarize your feelings?", "PREVIEW"]   //eventually will just pull from the viewmodel for this
