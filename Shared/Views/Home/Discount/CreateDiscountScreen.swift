                ...
                VStack (alignment: .center) {
                    ...
                    VStack(alignment: .center, spacing: 0) {
                        ...
                        Button {
                            ...
                            discountCodesViewModel.addToPersonalCode(discountID: rewardsProgram.ids.personalCardDiscountID, domain: rewardsProgram.ids.domain, graphqlID: rewardsProgram.ids.graphqlID, minimumSpendRequired: 0, pointsSpent: Int(rewardsUsed), rewardAmount: Int(rewardsUsed)/10, status: "ADDITION")
